...
const ApiKeyModal: React.FC<ApiKeyModalProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-900 border border-gray-800 rounded-lg shadow-2xl p-8 max-w-lg w-full text-center"
      ...
      >
        ...
        <p className="text-gray-400 mb-6">
          Enter your Gemini API Key to enable generation features. Your key is
